...
> 一個人、一份一輩子的紀錄、一個會替他說話的 AI。本文是產品全貌敘述，部分畫面與案例對應 2026-09-05；目前實作狀態以 [HANDOFF](HANDOFF.md) 與 [VALIDATION](VALIDATION.md) 為準。
...
- 本人 App：全像人體圖（EMBL-EBI 解剖向量圖）、3D 分身與沙盤模擬、穿戴每日指標、終身時間軸、問我的紀錄與唸給我聽
- 個人生理值正常帶（隊友的 baseline 引擎）＋ RF13「偏離他自己平常」：01 面板與護理站以文字呈現，沒有分數
- 模擬跌倒訊號、硬條件紅燈、四鍵驗證、事件資訊包
- OMNI-TWIN 深色殼、列印白底、對比稽核；api 140 個測試、web 型別與 lint 全綠
- 評測：46 句合成語句，provenance 100%、無診斷詞 100%、hallucination 6.5%

**第二階段（明確不做）**：Health Graph 知識圖；真實穿戴裝置、醫院 EHR／FHIR 對接；多語（印尼語、越南語）介面；02 風格美學、03 心理情緒飲食、04 全資產生命週期；用藥、影像、檢驗頁；器官級 3D 解剖模型；API 簽發的登入 token。
