    ...
    <div className="no-print mx-auto w-full max-w-6xl px-4 pt-3">
      {red.map((i) => (
        <RedFlagBanner
          ...
          action={
            <Link href={`/p/${i.patient_id}?tab=docs`} className="inline-flex min-h-14 items-center justify-center rounded-[10px] bg-danger px-4 text-base font-medium text-white hover:opacity-90">
              到場評估 →
            </Link>
          }
        />
